      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: MainTrackerWidget.routeName,
              path: MainTrackerWidget.routePath,
              requireAuth: true,
            ...
            FFRoute(
              name: CreateTask1SelectProjectWidget.routeName,
              path: CreateTask1SelectProjectWidget.routePath,
              requireAuth: true,
            ...
            FFRoute(
              ...
              builder: (context, params) => CreateTaskWidget(
                projectParameter: params.getParam(
                  'projectParameter',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              name: AddTeamMembersWidget.routeName,
              path: AddTeamMembersWidget.routePath,
              requireAuth: true,
              builder: (context, params) => AddTeamMembersWidget(),
            ),
            FFRoute(
              name: TeamMemberDetailsWidget.routeName,
              path: TeamMemberDetailsWidget.routePath,
              requireAuth: true,
              asyncParams: {
            ...
            FFRoute(
              name: MainProjectsWebWidget.routeName,
              path: MainProjectsWebWidget.routePath,
              requireAuth: true,
              builder: (context, params) => params.isEmpty
            ...
            FFRoute(
              name: MainTeamPageWidget.routeName,
              path: MainTeamPageWidget.routePath,
              requireAuth: true,
              builder: (context, params) => params.isEmpty
            ...
            FFRoute(
              name: MainProjectsWidget.routeName,
              path: MainProjectsWidget.routePath,
            ...
            FFRoute(
              name: CreateProjectWidget.routeName,
              path: CreateProjectWidget.routePath,
              requireAuth: true,
              builder: (context, params) => CreateProjectWidget(),
            ),
            FFRoute(
              name: ProjectDetailsPageWidget.routeName,
              path: ProjectDetailsPageWidget.routePath,
              requireAuth: true,
              asyncParams: {
            ...
            FFRoute(
              name: SearchMembersWidget.routeName,
              path: SearchMembersWidget.routePath,
              requireAuth: true,
              asyncParams: {
                'projectRef': getDoc(['projects'], ProjectsRecord.fromSnapshot),
              },
