                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataFis = true);
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .hideCurrentSnackBar();
                                  _model.isDataUploading_uploadDataFis = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataFis =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadDataFis =
                                        downloadUrls.first;
                                  });
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await currentUserReference!
                            ...
                            photoUrl: _model.uploadedFileUrl_uploadDataFis,
