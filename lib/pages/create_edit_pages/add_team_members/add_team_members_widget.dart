...
class AddTeamMembersWidget extends StatefulWidget {
  ...
  static String routeName = 'addTeamMembers';
  static String routePath = 'addTeamMembers';
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadData35e = true);
                                    ...
                                    try {
                                      ...
                                      ScaffoldMessenger.of(context)
                                          .hideCurrentSnackBar();
                                      _model.isDataUploading_uploadData35e =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadData35e =
                                            selectedUploadedFiles.first;
                                        _model.uploadedFileUrl_uploadData35e =
                                            downloadUrls.first;
                                      });
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.uploadedFileUrl_uploadData35e == null ||
                                _model.uploadedFileUrl_uploadData35e.isEmpty) {
                              return;
                            }
